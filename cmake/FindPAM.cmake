...
#  PAM_MODULE_DIR - where system modules are installed
...
find_library(PAM_MODULE_DIR NAMES pam_env.so pam_unix.so pam_localuser.so PATH_SUFFIXES security pam)

if (PAM_INCLUDE_DIR AND PAM_LIBRARY AND PAM_MODULE_DIR)
    get_filename_component(PAM_MODULE_DIR ${PAM_MODULE_DIR} PATH)
	set(PAM_FOUND TRUE)
	if (DL_LIBRARY)
...
endif (PAM_INCLUDE_DIR AND PAM_LIBRARY AND PAM_MODULE_DIR)
...
if (PAM_FOUND)
	...
	if (PAM_FIND_REQUIRED)
		if (NOT PAM_MODULE_DIR)
			message(FATAL_ERROR "PAM module destination path not found")
        endif(NOT PAM_MODULE_DIR)
